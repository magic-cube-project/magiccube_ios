...
+ (LBXScanViewStyle*)qqStyle
{
    ...
    // 修改网格颜色
    style.colorAngle = [UIColor colorWithRed:139.0/255.0 green:55.0/255.0 blue:255.0/255.0 alpha:100];
    
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"ScanCode.bundle/scan"];
