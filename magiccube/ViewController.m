...
- (void)initWKWebView
    {
        ...
        [configuration.userContentController addScriptMessageHandler:self name:@"onAuthorizateByexchange"];
        ...
        [self.webView evaluateJavaScript:@"navigator.userAgent" completionHandler:^(id result, NSError *error) {
            ...
            // 给User-Agent添加额外的信息
            NSString *newAgent = [NSString stringWithFormat:@"%@;%@", oldAgent, @"APP/JHELLO"];
        ...
        NSString *u1rlStr = [[NSBundle mainBundle] pathForResource:@"index" ofType:@"html"];
        
        NSURL *_url = [NSURL fileURLWithPath:u1rlStr];
...
- (void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message
    {
        ...
        //    }
        //
        //    if ([message.name isEqualToString:@"sucShop"]) {
        //        [self dismissViewControllerAnimated:YES completion:nil];
        //
        //        char tmp[255]= {0};
        //        sprintf(tmp, "cc.vv.anysdkMgr.shop_suc('%d')",-1);
        //    }
    }
